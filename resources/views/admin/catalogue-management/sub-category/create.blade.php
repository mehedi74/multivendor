                ...
                <div class="col-md-10 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('sub-category.create')}}" class="forms-sample" method="post"
                                  id="add-section" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Select Section<sup class="red">*</sup></label>
                                    <div class="select">
                                        <select name="section_id" required id="section_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <select name="category_id" required id="catId">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subcat_discount" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"  required name="subcat_image" id="input-file-now" class="dropify"/>
                                </div>
                                <div class="form-group">
                                    <label for="name">Url</label>
                                    <input type="text" name="subcat_url" class="form-control"
                                           id="subcat_url" placeholder="Enter url "/>
                                </div>
                                <div class="form-group">
                                    <label for="name">Meta Title</label>
                                    <input type="text" name="subcat_meta_title" class="form-control"
                                           id="subcat_meta_title" placeholder="Enter meta title "/>
                                </div>
                                <div class="form-group">
                                    <label for="name">Meta Description</label>
                                    <input type="text" name="subcat_meta_description" class="form-control"
                                           id="subcat_meta_description" placeholder="Enter meta description "/>
                                </div>
                                <div class="form-group">
                                    <label for="name">Meta Keywords</label>
                                    <input type="text" name="subcat_meta_keywords" class="form-control"
                                           id="subcat_meta_keywords" placeholder="Enter meta keywords "/>
                                </div>
                                <div class="form-group">
                                    <label for="status">Publication Status</label>
                                    <div>
                                        <label><input type="radio" name="subcat_status" value="1" id="" checked>
                                            Publish</label>
                                        <label style="margin-left: 10px;"><input type="radio" name="subcat_status" value="0" id=""> Unpublish</label>
                                    </div>
                                </div>
