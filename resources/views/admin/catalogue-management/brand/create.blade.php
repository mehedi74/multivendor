                ...
                <div class="col-md-10 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('brand.create')}}" class="forms-sample" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_discount" class="form-control" id="subcat_discount" placeholder="Enter discount "/>
                                </div>
                                <div class="form-group">
                                    <label for="status">Publication Status</label>
                                    <div>
                                        <label><input type="radio" name="brand_status" value="1" id="" checked>
                                            Publish</label>
