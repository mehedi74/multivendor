...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets')}}/admin/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="{{asset('assets')}}/admin/css/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
